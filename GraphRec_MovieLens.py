...
def main():
    ...
    parser.add_argument('--batch_size', type=int, default=128, metavar='N', help='input batch size for training') # Changed 128 -> 256
    parser.add_argument('--embed_dim', type=int, default=64, metavar='N', help='embedding size') # Changed 64 -> 16
    parser.add_argument('--lr', type=float, default=0.001, metavar='LR', help='learning rate')
    parser.add_argument('--test_batch_size', type=int, default=1000, metavar='N', help='input batch size for testing') # Changed 1000 -> 2000
    ...
    data_path = 'ml-32m/movielens.pickle'
    ...
    try:
        ...
        print("Please run 'python preprocess_movielens.py' first.")
        return
    # ------------------------------------
